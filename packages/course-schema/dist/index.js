...
export const CompetencySchema = z.object({
    ...
    title: z.string(),
    description: z.string().refine((val) => val.startsWith("Can "), { message: "Competency description must start with 'Can '" }),
...
export const ScenarioSchema = z.object({
    ...
    }).refine((variants) => variants.interview || variants.assessment || variants.ongoing, { message: "At least one scenario variant is required" }),
...
// ============================================================================
export function validateCourseExport(data) {
    return CourseExportSchema.parse(data);
}
export function safeParseCourseExport(data) {
    return CourseExportSchema.safeParse(data);
}
export function validateCompetencyFramework(data) {
    return CompetencyFrameworkSchema.parse(data);
}
export function safeParseCompetencyFramework(data) {
